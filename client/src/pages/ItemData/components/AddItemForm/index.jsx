...
import { setItemData } from '@pages/ItemData/actions';
...
const AddItemFormModal = ({ isOpen, onClose }) => {
  ...
  const onSubmit = (data) => {
    dispatch(setItemData({kategori_id: 1, name: data.name, desc: data.desc, price: data.price, stock: data.stock, img: image, author_id: 1}));
    reset();
    setImage(null);
    setShowImage(false);
    onClose();
